...
- Open :fileLink[src/server.js]{path="src/server.js"} the API. Note it's hard-coded to **port 3000**.
- Open :fileLink[Dockerfile]{path="Dockerfile"} a single-stage build on `node:22-slim`, running as **root**.
...
Open the running app in the **Product Catalog** tab:

::tabLink[Open the Product Catalog]{href="http://localhost:8090" title="Product Catalog" id="app"}
